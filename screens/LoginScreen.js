  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.card}>
        <Text style={[styles.title, {fontFamily: theme.fonts.main.bold}]}>Вход</Text>

        <View style={styles.inputContainer}>
          <Image
            source={require('../assets/pic/email.png')}
        ...
        <View style={styles.inputContainer}>
          <Image
            source={require('../assets/pic/lock.png')}
            style={styles.inputIcon}
            resizeMode="contain"
          />
          <TextInput
        ...
        <TouchableOpacity
          style={[styles.button, theme.grayButton.button]}
          onPress={handleLogin}
          disabled={loading}
        >
          <Text style={[styles.buttonText, { fontFamily: theme.fonts.secondary.regular }]}>
        ...
        <View style={[styles.registerContainer, { flexDirection: 'column', alignItems: 'center' }]}>
          <Text style={[styles.registerText, { fontFamily: theme.fonts.secondary.regular }]}>
            Еще нет аккаунта?
          </Text>
          <TouchableOpacity onPress={handleRegister}>
            <Text style={[styles.registerLink, { fontFamily: theme.fonts.secondary.bold }]}>
              Зарегистрироваться
            </Text>
          </TouchableOpacity>
        </View>
